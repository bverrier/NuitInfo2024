...
require_once __DIR__.'/croissantLib.php';
	...
	class Header
	{
		...
		public function getHeader(string $title):string
		{
            ...
            $html .= (!empty($_GET['page'])) ? '		<script src="./js/bootstrap/bootstrap.bundle.min.js"></script>' ."\n" : '';
            $html .= (!empty($_GET['page'])) ? '		<script src="./js/jquery-3.5.1.js"></script>' ."\n" : '';
            $html .= (!empty($_GET['page'])) ? '		<script src="./js/jquery.dataTables.min.js"></script>' ."\n" : '';
            $html .= (!empty($_GET['page'])) ? '		<script src="./js/bootstrap/dataTables.bootstrap5.min.js"></script>' ."\n" : '';
            $html .= (!empty($_GET['page'])) ? '		<script src="./js/ajax/admin.js"></script>' ."\n" : '';
            $html .= (!empty($_GET['page'])) ? '		<script src="./js/index.js"></script>' ."\n" : '';
            ...
            $html .= (!empty($_GET['page']) && $_GET['page'] == 'Météo') ? '<script src="./js/ajax/meteo.js"></script>'."\n" : '';
